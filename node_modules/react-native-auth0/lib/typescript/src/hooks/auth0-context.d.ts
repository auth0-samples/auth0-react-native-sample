...
import { ClearSessionParameters, LoginWithEmailOptions, LoginWithOOBOptions, LoginWithOTPOptions, LoginWithRecoveryCodeOptions, LoginWithSMSOptions, MultifactorChallengeOptions, PasswordlessWithEmailOptions, Credentials, User, WebAuthorizeOptions, WebAuthorizeParameters, PasswordlessWithSMSOptions, ClearSessionOptions } from '../types';
...
export interface Auth0ContextInterface<TUser extends User = User> extends AuthState<TUser> {
     ...
     */
    authorize: (parameters: WebAuthorizeParameters, options: WebAuthorizeOptions) => Promise<Credentials | undefined>;
    /**
     ...
     */
    sendMultifactorChallenge: (parameters: MultifactorChallengeOptions) => Promise<void>;
    /**
     ...
     */
    authorizeWithRecoveryCode: (parameters: LoginWithRecoveryCodeOptions) => Promise<Credentials | undefined>;
    /**
     ...
     * @returns
     */
    getCredentials: (scope?: string, minTtl?: number, parameters?: Record<string, unknown>, forceRefresh?: boolean) => Promise<Credentials | undefined>;
    /**
     ...
     */
    requireLocalAuthentication: (title?: string, description?: string, cancelTitle?: string, fallbackTitle?: string, strategy?: LocalAuthenticationStrategy) => Promise<void>;
}
