import { createRunOncePlugin, withAppBuildGradle, withAppDelegate, withInfoPlist } from 'expo/config-plugins';
...
export const addAuth0GradleValues = function (src, auth0Domain) {
...
export const addAndroidAuth0Gradle = (props, config) => {
  if (config.modResults.language === 'groovy') {
    var _config$android;
    if (!(props !== null && props !== void 0 && props.domain)) {
      throw Error('No auth0 domain specified in expo config');
    }
    const auth0Domain = props.domain;
    let applicationId;
    if ((_config$android = config.android) !== null && _config$android !== void 0 && _config$android.package) {
      var _config$android2;
      applicationId = ((_config$android2 = config.android) === null || _config$android2 === void 0 ? void 0 : _config$android2.package) + APPLICATION_ID_SUFFIX;
    }
...
export const addIOSAuth0ConfigInInfoPList = (props, config) => {
  ...
  if ((_config$ios = config.ios) !== null && _config$ios !== void 0 && _config$ios.bundleIdentifier) {
    var _config$ios2;
    bundleIdentifier = ((_config$ios2 = config.ios) === null || _config$ios2 === void 0 ? void 0 : _config$ios2.bundleIdentifier) + APPLICATION_ID_SUFFIX;
  }
