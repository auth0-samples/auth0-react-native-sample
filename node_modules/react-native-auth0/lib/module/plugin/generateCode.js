 ...
 */
export function mergeContents(_ref) {
  let {
    src,
    newSrc,
    tag,
...
export function removeContents(_ref2) {
  let {
    src,
    tag
  } = _ref2;
 ...
 * @param src
 */
export function removeGeneratedContents(src, tag) {
  const {
    contents,
    start,
    end
...
export function createGeneratedHeaderComment(contents, tag, comment) {
...
export function createHash(src) {
