...
export declare type MultifactorChallengeOTPResponse = {
    challengeType: string;
};
export declare type MultifactorChallengeOOBResponse = MultifactorChallengeOTPResponse & {
    oobCode: string;
};
export declare type MultifactorChallengeOOBWithBindingResponse = MultifactorChallengeOOBResponse & {
    bindingMethod: string;
};
export declare type MultifactorChallengeResponse = MultifactorChallengeOTPResponse | MultifactorChallengeOOBResponse | MultifactorChallengeOOBWithBindingResponse;
